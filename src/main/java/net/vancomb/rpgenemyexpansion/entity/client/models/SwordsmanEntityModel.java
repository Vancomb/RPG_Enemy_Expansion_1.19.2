package net.vancomb.rpgenemyexpansion.entity.client.models;// Made with Blockbench 4.8.3
...
public class SwordsmanEntityModel extends EntityModel<SwordsmanEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(RpgEnemyExpansion.MOD_ID, "swordsman_entity"), "main");
	...
	public SwordsmanEntityModel(ModelPart root) {
	...
	@Override
	public void setupAnim(SwordsmanEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
